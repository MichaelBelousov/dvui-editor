...
pub const SpriteInitOptions = struct {
    ...
    file: ?*inkz_editor.Internal.File = null,
    alpha_source: ?dvui.ImageSource = null,
    sprite: inkz_editor.Atlas.Sprite,
    scale: f32 = 1.0,
    ...
    if (init_opts.reflection) {
        ...
        if (init_opts.alpha_source) |alpha_source| {
            ...
            if (init_opts.file) |file| {
                const preview_opts = inkz_editor.render.RenderFileOptions{
                    .file = file,
                    .rs = .{
                ...
                inkz_editor.render.renderReflectionLayerStack(preview_opts, reflection_triangles_layers, reflection_triangles_layers_dimmed) catch |err| {
